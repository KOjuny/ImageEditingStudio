...
def edit_image_EF(edit_method,
    ...
    if edit_method=="edit-friendly-inversion+p2p":
        ...
        with autocast("cuda"), inference_mode():
            w0 = (ldm_stable.vae.encode(image_gt).latent_dist.mode() * 0.18215).float() # torch.Size([1, 4, 64, 64]), vae를 통해 image를 encoding하는 과정.
        ...
        # wt는 inversion을 통해 얻은 최종 latent, zs는 중간 노이즈 50개, wts는 모든 latent 51개
        ...
        # x0_reconstruct : torch.Size([1, 4, 64, 64]), reconstruction한 latent
        ...
        with autocast("cuda"), inference_mode():
            ...
            # x0_reconstruct_edit이랑 x0_reconstruct랑 뭐가 다른거지
